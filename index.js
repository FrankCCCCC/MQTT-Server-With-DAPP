...
var port = process.env.PORT || 4000;// Set up localhost port
...
// Index.js listen to MQTT server(localhost://127.0.0.1)
...
client.on('message', function (topic, message) {//When Recive message
  ...
  // Fire a socket message, and then it will execute sio.on();
